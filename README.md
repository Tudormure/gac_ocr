...
Before run: 
Download **Parallel Computing Toolbox** add-on:<br/>
     in MATLAB: Home -> Add-Ons -> Explore Add-Ons -> Search for **Parallel Computing Toolbox** -> Install

Right-Click on functii folder -> Add to path -> Selected Folder(s) and Subfolders
