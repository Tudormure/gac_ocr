...
3.  To train on the gpu you must install Parallel Computing Toolbox and have a nvidia graphic card, then uncomment the lines from init_params and add the comments inside function brackets, (ex. params.W1 = randn(hidden_size,in_size,'gpuArray')*0.01;)
